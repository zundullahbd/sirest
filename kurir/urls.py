...
urlpatterns = [
    ...
    path('kurir-riwayat_pesanan/', riwayat_pesanan, name='riwayat_pesanan_kurir'),
    path('list_pesanan_berlangsung/', list_pesanan_berlangsung, name='list_pesanan_berlangsung'),
    path('detail_pesanan_berlangsung/', detail_pesanan_berlangsung, name='detail_pesanan_berlangsung'),
]